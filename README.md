...
* In one terminal, type npm install.
* After installing node_packages folder, type cd client and hit enter. Type npm start. This will start up the frontend portion of this project.
* In the other terminal, type cd server and hit enter. Type npm start. This will start up the backend portion of this project.
